...
export const projects: ProjectDetail[] = [
  {
    ...
    decisions: [
      ...
      {
        title: { en: 'Supabase over a custom backend', sk: 'Supabase namiesto vlastného backendu' },
        detail: {
          en: 'For an early-stage product, building a custom API server would have tripled development time. Supabase provided auth, real-time subscriptions, and a relational database out of the box — freeing capacity for product work.',
          sk: 'Pre produkt v ranej fáze by budovanie vlastného API servera strojnásobilo čas vývoja. Supabase poskytol autentifikáciu, real-time subscriptions a relačnú databázu bez zbytočného nastavenia — čím uvoľnil kapacitu na produktovú prácu.'
        }
      },
      {
        title: { en: 'Composables as the backend boundary', sk: 'Composables ako hranica backendu' },
        detail: {
          ...
          sk: 'Všetky Supabase dotazy žijú v composables, nie v komponentoch. Výmena alebo rozšírenie backendu neskôr znamená úpravu jednej vrstvy, nie desiatok súborov roztrúsených po celej kódovej základni.'
        }
      },
      {
        title: { en: 'No premature optimisation', sk: 'Žiadna predčasná optimalizácia' },
        detail: {
          ...
          sk: 'Virtualizáciu a lazy storeы som preskočil, kým nebol dôkaz, že ich aplikácia potrebuje. Nízka zložitosť v ranej fáze urýchlila onboarding a zjednodušila debugovanie.'
        }
      }
    ],
    outcome: {
      ...
      sk: `Platforma bola odovzdaná v termíne s čistou, prehľadnou kódovou základňou. Nové funkcie trvajú výrazne menej času, pretože architektúra anticipuje zmeny. Po prvom vydaní neboli potrebné žiadne väčšie refaktory — priamy výsledok dizajnových rozhodnutí na začiatku.`
    },
...

  {
    ...
    decisions: [
      {
        title: { en: 'SSR over pre-rendering', sk: 'SSR namiesto pre-renderingu' },
        detail: {
    ...
    stack: ['Nuxt 3', 'Vue 3', 'TypeScript', '@nuxt/image', 'nuxt-simple-sitemap'],
    improvements: {
      en: [
...

  {
    ...
    stack: ['Vue 3', 'TypeScript', 'vue-virtual-scroller', 'Web Workers', 'Chart.js'],
    improvements: {
      en: [
